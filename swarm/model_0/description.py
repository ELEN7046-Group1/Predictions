...
config ={
  ...
  'modelParams' : {'sensorParams': {'encoders': {u'Date_dayOfWeek': None, '_classifierInput': {'maxval': 230, 'classifierOnly': True, 'minval': 0, 'clipInput': True, 'n': 275, 'fieldname': 'DayTotal', 'w': 21, 'type': 'ScalarEncoder'}, u'DayTotal': {'maxval': 230, 'name': 'DayTotal', 'clipInput': True, 'minval': 0, 'n': 272, 'fieldname': 'DayTotal', 'w': 21, 'type': 'ScalarEncoder'}, u'Date_timeOfDay': None, u'Date_weekend': None}}, 'spParams': {'synPermInactiveDec': 0.05015}, 'tpParams': {'minThreshold': 11, 'activationThreshold': 14, 'pamLength': 3}, 'clParams': {'alpha': 0.050050000000000004}},
